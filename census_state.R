####### CENSUS DATA MANIPULATION (at the state level)
...
data_of_interest <- get_acs(geography = "county", variables = select_vars, year = 2020)
...
data_of_interest <- data_of_interest %>% spread(variable, estimate)
## place of birth
...
hist(data_of_interest$prop.EAsia)
hist(data_of_interest$prop.Cuba)
hist(data_of_interest$prop.Mexico)
hist(data_of_interest$prop.PR)
hist(data_of_interest$prop.SAmer)
hist(data_of_interest$prop.WAsia)
hist(data_of_interest$prop.SubSahAfr)
hist(data_of_interest$prop.Native)
hist(data_of_interest$prop.ten_own)
hist(data_of_interest$prop.disab)
hist(data_of_interest$prop.no_int)
...
write_csv(data_of_interest, "/Users/spencerblackwood/Desktop/ypccc/census_state.csv")
